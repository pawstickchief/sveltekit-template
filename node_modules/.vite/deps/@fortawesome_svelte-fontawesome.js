...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    if ("tag" in $$props2) $$invalidate(3, tag = $$props2.tag);
    if ("props" in $$props2) $$invalidate(4, props = $$props2.props);
    if ("children" in $$props2) $$invalidate(5, children2 = $$props2.children);
...
function instance2($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$new_props) => {
    ...
    if ("icon" in $$new_props) $$invalidate(9, icon2 = $$new_props.icon);
  ...
  $$self.$inject_state = ($$new_props) => {
    ...
    if ("icon" in $$props) $$invalidate(9, icon2 = $$new_props.icon);
